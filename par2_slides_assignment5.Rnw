...
\subsection{LD50(mg/kg) and Real content(lb) of Brocoli}
\subsection{LD50(mg/kg) and Real content(lb) of Cauliflower}
...
\begin{frame}[fragile]{Data Visualization}{LD50(mg/kg) and Real content(lb) of Brocoli}
\begin{figure}
